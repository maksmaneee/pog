...
twitch_miner = TwitchChannelPointsMiner(
    ...
    password=os.environ.get('TWITCH_PASSWORD'),           # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(
    [
       Streamer("evelone2004", settings=StreamerSettings(make_predictions=True  , follow_raid=True , claim_drops=True  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=50000   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,      where=Condition.LTE, value=800 ) ) )),
       Streamer("shadowkekw", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=True ,   watch_streak=True  ,  bet=BetSettings(strategy=Strategy.SMART , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=50000  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=800 ) ) )),
